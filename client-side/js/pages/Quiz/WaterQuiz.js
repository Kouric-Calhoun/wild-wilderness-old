export default function WaterQuiz() {
    return `
    <center><h1 class ="quiz-name">Survival Water Skill Quiz</h1></center>
    <div class ="water-quiz">
    <div class="question-container-one">
    <h3 class="question">Question 1: Which water contains algae that harbor microorganisms and can clog water 
    ...
    <h3 class="question">Question 2: How do water purification tablets work?</h3>
    ...
    <h3 class="question">Question 3: Why is it important NOT to drink water with high levels of sodium and minerals?</h3>
