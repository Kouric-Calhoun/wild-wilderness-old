export default function Water(){
    ...
    chance for bacteria.</p>
        <p>Now then, how do you go about finding these bodies of water? First, use your senses. If you stand perfectly still and listen 
    ...
    if you aren’t careful.</p>
        <p>One way to separate the water from its salts and minerals is to distill it. However, this process requires some items that might not be
    ...
    back into liquid. It's possible to do this with two glass bottles, or with a pot, aluminum foil, and a glass jar.</p>
        <p>By placing the smaller vessel inside the larger one and filling the larger one with salt water, you can cover it and let condensation 
